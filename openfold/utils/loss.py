...
def experimentally_resolved_loss(
    ...
    **kwargs,
    ...
    loss = torch.sum(errors * atom37_atom_exists, dim=(-1,-2))
    # logging.warning(f"the shape of loss is {loss.shape}")
    # logging.warning(f"the shape of atom37_atom_exists is {atom37_atom_exists.shape}")
