...
class SidechainIpaModule(nn.Module):
    def __init__(
        self,
        c_m,
        c_s,
        ...
        **kwargs,
        ...
        Args:
            ...
            inf:
                Large number used for attention masking
        """
        super(SidechainIpaModule, self).__init__()
        self.c_m = c_m
        self.c_s = c_s
        self.c_z = c_z
        self.c_ipa = c_ipa
        ...
        self.bb_update = BackboneUpdate(self.c_s)
        self.linear_s = Linear(self.c_m, self.c_s)
    ...
    def forward(
        ...
        # [*, N]
        rigids = Rigid.from_tensor_7(rigids_prev)
